...
async function seed() {
  ...
  await Promise.all([
    Agent.create({
      ...
      agentLicense: '1234567890',
      address: '908 Bel Air Rd, Los Angeles, CA 90077',
      practiceAreas: ['Los Angeles', 'San Diego', 'New York', 'Miami'].join(','),
      reviews: JSON.stringify(['Sold me an overpriced house that got flooded a month later.']),
